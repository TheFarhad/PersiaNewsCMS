...
public class NewsCreatedEvent : IEvent
{
    ...
    private NewsCreatedEvent(Guid code, string title, string description, string body, List<Keyword> keywords)
    {
        Code = code;
        Title = title;
    ...
    public static NewsCreatedEvent Instance(Guid code, string title, string description, string body, List<Keyword> keywords) =>
