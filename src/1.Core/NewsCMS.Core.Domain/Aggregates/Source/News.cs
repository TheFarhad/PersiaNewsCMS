...
public class News : Source
{
    ...
    private List<NewsKeyword> _keywords = new();
    public IReadOnlyList<NewsKeyword> Keywords => _keywords.AsReadOnly();

    private News() { }
    private News(NewsTitle title, Description description, string body, List<NewsKeyword> keywords) =>
        Init(title, description, body, keywords, null);

    public static News Instance(NewsTitle title, Description description, string body, List<NewsKeyword> keywords) => new(title, description, body, keywords);

    private void Init(NewsTitle title, Description description, string body, List<NewsKeyword> keywords, Action action = null)
    {
    ...
    public void Edit(NewsTitle title, Description description, string body, List<NewsKeyword> keywords)
    {
    ...
    private void SetKeywords(List<NewsKeyword> keywords) => _keywords = keywords;
